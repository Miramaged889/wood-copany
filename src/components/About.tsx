      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            شركة النشامى هي إحدى الشركات الرائدة في مجال تجارة وتصنيع الأخشاب
            والديكورات في المملكة العربية السعودية
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              بدأت شركة النشامى رحلتها منذ أكثر من 15 عامًا بهدف تقديم أفضل
              الحلول في مجال تجارة الأخشاب وتصنيع الديكورات الداخلية والخارجية.
              نحن نفخر بتقديم خدمات متميزة تلبي احتياجات عملائنا من القطاعين
              السكني والتجاري.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
          <div className="text-center p-8 bg-[#F5F2EC] rounded-lg">
            ...
            <p className="text-gray-600">
              تقديم أفضل الحلول في مجال الأخشاب والديكورات بجودة عالية وأسعار
              تنافسية
            </p>
          </div>
          <div className="text-center p-8 bg-[#F5F2EC] rounded-lg">
